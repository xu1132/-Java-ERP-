...
CREATE TABLE `t_customer`  (
  ...
  `customer_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '客户名称',
  `contacts` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '联系人',
  `phone_number` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '联系人电话',
  `address` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '客户地址',
...
CREATE TABLE `t_customer_return_list`  (
  ...
  `return_number` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '退货单号',
  `return_date` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '退货日期',
  ...
  `remarks` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
...
CREATE TABLE `t_customer_return_list_goods`  (
  ...
  `goods_code` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品编码',
  `goods_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品名称',
  `goods_model` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品型号',
  `goods_num` int NULL DEFAULT NULL COMMENT '客户退货数量',
  `goods_unit` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品单位',
  ...
  INDEX `FKtqt67mbn96lxn8hvtl4piblhi`(`customer_return_list_id` ASC) USING BTREE,
  INDEX `FK32ijokbrx3j6h0p6aa9hcccbq`(`goods_type_id` ASC) USING BTREE,
...
CREATE TABLE `t_damage_list`  (
  ...
  `damage_number` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品报损单号',
  `damage_date` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建日期',
  `remarks` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `user_id` int NULL DEFAULT NULL COMMENT '用户id，外键',
  PRIMARY KEY (`damage_list_id`) USING BTREE,
  INDEX `FKpn094ma69sch1icjc2gu7xus`(`user_id` ASC) USING BTREE,
...
CREATE TABLE `t_damage_list_goods`  (
  ...
  INDEX `FKbf5m8mm3gctrnuubr9xkjamj8`(`damage_list_id` ASC) USING BTREE,
  INDEX `FK8r7ietq6opa0ci7uxdqc264yf`(`goods_type_id` ASC) USING BTREE,
  INDEX `goods_id`(`goods_id` ASC) USING BTREE,
...
CREATE TABLE `t_goods`  (
  ...
  `goods_model` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品型号',
  `goods_producer` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '生产厂商',
...
CREATE TABLE `t_goods_type`  (
  ...
  `goods_type_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品类别名称',
...
CREATE TABLE `t_log`  (
  ...
  `log_type` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '日志类型',
  `content` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '日志内容',
  `log_date` datetime NULL DEFAULT NULL COMMENT '日志时间',
  `user_id` int NULL DEFAULT NULL COMMENT '用户id，外键',
  PRIMARY KEY (`log_id`) USING BTREE,
  INDEX `FKbvn5yabu3vqwvtjoh32i9r4ip`(`user_id` ASC) USING BTREE,
  CONSTRAINT `t_log_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 6055 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_menu`  (
  ...
  `menu_icon` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '菜单图片',
  ...
  `menu_url` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '菜单的链接地址',
  PRIMARY KEY (`menu_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6050 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_overflow_list`  (
  ...
  `overflow_number` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品报溢单号',
  `overflow_date` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '报溢日期',
  `remarks` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `user_id` int NULL DEFAULT NULL COMMENT '用户id，外键',
  PRIMARY KEY (`overflow_list_id`) USING BTREE,
  INDEX `FK3bu8hj2xniqwbrtg6ls6b8ej2`(`user_id` ASC) USING BTREE,
...
CREATE TABLE `t_overflow_list_goods`  (
  ...
  INDEX `FKd3s9761mgl456tn2xb0d164h7`(`overflow_list_id` ASC) USING BTREE,
  INDEX `FK20rudkne4kc8uftcenkrng1mn`(`goods_type_id` ASC) USING BTREE,
  INDEX `goods_id`(`goods_id` ASC) USING BTREE,
...
CREATE TABLE `t_purchase_list`  (
  ...
  `purchase_number` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '进货单号',
  `amount_paid` float NOT NULL COMMENT '实付金额',
  `amount_payable` float NOT NULL COMMENT '应付金额',
  `purchase_date` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收货日期',
  `remarks` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
...
CREATE TABLE `t_purchase_list_goods`  (
  ...
  INDEX `goods_id`(`goods_id` ASC) USING BTREE,
  INDEX `purchase_list_id`(`purchase_list_id` ASC) USING BTREE,
  INDEX `goods_type_id`(`goods_type_id` ASC) USING BTREE,
...
CREATE TABLE `t_return_list`  (
  ...
  INDEX `FK4qxjj8bvj2etne243xluni0vn`(`supplier_id` ASC) USING BTREE,
  INDEX `FK904juw2v1hm2av0ig26gae9jb`(`user_id` ASC) USING BTREE,
...
CREATE TABLE `t_return_list_goods`  (
  ...
  INDEX `FKemclu281vyvyk063c3foafq1w`(`return_list_id` ASC) USING BTREE,
  INDEX `FKpxnqi9jfkw6wdm1uox2kkr0wk`(`goods_type_id` ASC) USING BTREE,
  INDEX `goods_id`(`goods_id` ASC) USING BTREE,
...
CREATE TABLE `t_role_menu`  (
  ...
  INDEX `FKhayg4ib6v7h1wyeyxhq6xlddq`(`menu_id` ASC) USING BTREE,
  INDEX `FKsonb0rbt2u99hbrqqvv3r0wse`(`role_id` ASC) USING BTREE,
...
CREATE TABLE `t_sale_list`  (
  ...
  `sale_number` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '销售单号',
  `amount_paid` float NOT NULL COMMENT '实付金额',
  `amount_payable` float NOT NULL COMMENT '应付金额',
  `sale_date` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '销售单创建日期',
  `state` int NULL DEFAULT NULL COMMENT '状态',
  `remarks` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `customer_id` int NULL DEFAULT NULL COMMENT '客户id，外键',
  `user_id` int NULL DEFAULT NULL COMMENT '用户id，外键',
  PRIMARY KEY (`sale_list_id`) USING BTREE,
  INDEX `FKox4qfs87eu3fvwdmrvelqhi8e`(`customer_id` ASC) USING BTREE,
  INDEX `FK34bnujemrdqimbhg133enp8k8`(`user_id` ASC) USING BTREE,
...
CREATE TABLE `t_sale_list_goods`  (
  ...
  INDEX `FK20ehd6ta9geyql4hxtdsnhbox`(`sale_list_id` ASC) USING BTREE,
  INDEX `FK39ej927qf0ldkykafj2nhyu3u`(`goods_type_id` ASC) USING BTREE,
  INDEX `goods_id`(`goods_id` ASC) USING BTREE,
...
CREATE TABLE `t_supplier`  (
  ...
  `contacts` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '联系人',
  `phone_number` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '联系人电话',
  `address` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '供应商地址',
  `remarks` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
...
CREATE TABLE `t_unit`  (
  ...
  `unit_name` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品单位名称',
...
CREATE TABLE `t_user`  (
  ...
  `true_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '真实姓名',
  `roles` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '角色',
  `remarks` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 'admin', 'admin123', 'admin', '', '管理员');
INSERT INTO `t_user` VALUES (3, 'marry', '123456', 'marry', '仓库管理员,销售经理,采购员,主管', '销售经理');
INSERT INTO `t_user` VALUES (10, 'gucaini', '123456', 'root', '采购员,主管,销售经理', '');
